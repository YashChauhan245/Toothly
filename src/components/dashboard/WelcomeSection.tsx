...
export default async function WelcomeSection() {
  ...
  return (
    ...
    <div className="relative z-10 flex flex-col md:flex-row md:items-center md:justify-between items-center text-center md:text-left ...">
      ...
      <div className="lg:flex hidden items-center justify-center size-32 bg-gradient-to-br from-primary/20 to-primary/10 rounded-full ">
        <Image src="/logo1.png" alt="Toothly" width={64} height={64} className="w-16 h-16" />
      </div>
    </div>
  );
}