...
function CTA() {
  return (
    <section className="relative pt-14 pb-16 px-6 overflow-hidden bg-gradient-to-br from-muted/10 via-background to-muted/5">
        ...
        <div className="grid lg:grid-cols-2 gap-10 items-center">
          ...
          <div className="relative flex justify-center lg:justify-end">
            <div className="relative">
              ...
              {/* Main Image */}
              <div className="relative">
                <div className="absolute inset-0 bg-gradient-to-br from-primary/10 to-transparent rounded-2xl blur-xl scale-110" />

                <Image
                  src="/cta.png"
                  alt="Toothly AI Assistant"
                  width={300}
                  height={300}
              ...
              {/* Decorative Elements */}
              <div className="absolute -bottom-2 -right-2 w-16 h-16 bg-gradient-to-br from-primary/10 to-primary/5 rounded-full blur-lg" />
            </div>
          </div>
        </div>
      </div>
